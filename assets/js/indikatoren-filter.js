...
function preparePortalView(){
  ...
  renderThema();
  renderMultiselectDropdownFromJson(["Schweiz", "Grossregion", "Kanton", "Gemeinde", "Wohnviertel", "Bezirk", "Block", "Blockseite", "Innenstadt", "Agglomeration"], '', '#raeumlicheGliederung_filter', false);

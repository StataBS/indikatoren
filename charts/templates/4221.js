(function(){return {
    ...
    "events": {
      ...
      "load": function () {
								...
								.add().on('click',function(){
									 window.top.location.href = "http://www.umweltberichtbeiderbasel.bs.ch/indikatoren-06-0603", "Indikator-Details";
								});
  ...
  "title": {
    "text": "Anteil erneuerbarer Energien (ohne Mobilität)",
    "useHTML": true,
    "align": "left",
    "style": {
      "fontSize": "1.1666em",

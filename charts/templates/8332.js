		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendRectangle(chart, 243, 212, 105+10, 145, '#ffffff');
					fn.addLegendRectangle(chart, 355, 212, 110+10, 145, '#ffffff');
					
					fn.addLegendTitle(chart, choroplethSeries.name.replace(" ", "<br/>").replace(" ", "<br/>"), lp.blockChoropleth.title.x, lp.blockChoropleth.title.y[2]);

		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendLabelbold(chart, 'Anzahl Arbeitsstätten', 265, 220, 'pieLegendStayeOnZoom');
					fn.addLegendTitle(chart, 'Arbeitsstätten pro 100 Einwohner', 265, 300);

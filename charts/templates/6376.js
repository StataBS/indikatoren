		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name/*'Anteil Personen über 64 Jahren in %'*/, 265, 300);
					fn.addLegendLabelbold(chart, pieSizeSeries.name/*'Anzahl Personen über 64 Jahren'*/, 265, 220);

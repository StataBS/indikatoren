(function(){return {
    ...
    "events": {
      ...
      "load": function () {
								...
								.add().on('click',function(){
									 window.top.location.href = "http://www.umweltberichtbeiderbasel.bs.ch/indikatoren-10-1002", "Indikator-Details";
								});
  ...
  "subtitle": {
    "text": "Prozent (Anteil an Bevölkerung), Basel-Stadt",
    "useHTML": true,
    "align": "left",
    "style": {
      "fontSize": "1em",
  ...
  "tooltip": {
    ...
    "pointFormat": " \u003Cb\u003E{point.y}\u003C\u002Fb\u003E% \u003C\u002Fspan\u003E\u003C\u002Fspan\u003E",
    "footerFormat": "",
    "useHTML": true,
    "outside": false
  },
  ...
  "series": [
    {
      ...
      "color": "#FF8028",
      "id": "BS1002_1",
      "valueSuffix": "Prozent (Anteil an Bevölkerung)",
      "visible": true
    },
    {
      "includeInCSVExport": true,

...
*/
					...
					fn.addLegendRectangle(chart, lp.blockChoropleth.x, lp.blockChoropleth.y, lcw, lh, '#ffffff');
					fn.addLegendRectangle(chart, lp.blockSymbol.x, lp.blockChoropleth.y, lsw, lh, '#ffffff');

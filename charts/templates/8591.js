		...
		"legend": {
         ...
         colorAxis: {
        	...
        	dataClasses: [{
                ...
                to:0.249,
                color: '#D3E2E4',
                name:  "<span style='color: rgba(0,0,0,0)'>00,00</span> < 0,24"
            }, {
                from: 0.250,
                to: 0.2999,
                color: '#A8C3CA',
                name: "<span style='color: rgba(0,0,0,0)'>0</span>0,25 − 0,29"
            }, {
                from: 0.300,
                to: 0.349,
                 color: '#689199',
                 name: "<span style='color: rgba(0,0,0,0)'>0</span>0,30 − 0,34"
            },{
                from: 0.350,
                to: 0.399,
                 color: '#246370',
                 name: "<span style='color: rgba(0,0,0,0)'>0</span>0,35 − 0,39"
            },{
                from: 0.4,
                color: '#083038',
                name:  "<span style='color: rgba(0,0,0,0)'>00,00</span> ≥ 0,40"
            }], 
        },
        "data": {
		    "seriesMapping": [

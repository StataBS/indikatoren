		...
		"series": [
			{
				...
				tooltip: {
					pointFormatter: function(){
						//console.log(this);
						return this.properties.LIBGEO +': <b>' + Highcharts.numberFormat((this.value),1);
					}
				}
			}, 
			{
	            ...
	            load: function (e) {
					...
					var pieSeriesConfig = function(data, correspondingMapSeriesItem, color){
						return {
	                        ...
	                        tooltip: {
	                            pointFormatter: function () {
	                            	return correspondingMapSeriesItem.properties.LIBGEO +': <b>' + Highcharts.numberFormat((this.v),1);
	                            }
	                        }
	                    };
					};
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace("lien", "lien-<br/>"), lp.blockChoropleth.title.x, lp.blockChoropleth.title.y[1]);
					
					fn.addLegendTitle(chart, pieSizeSeries.name.replace("z ", "z<br/> "), lp.blockSymbol.title.x, lp.blockChoropleth.title.y[1]);

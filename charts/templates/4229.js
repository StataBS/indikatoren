(function(){return {
    ...
    "events": {
      ...
      "load": function () {
								...
								.add().on('click',function(){
									 window.top.location.href = "http://www.umweltberichtbeiderbasel.bs.ch/indikatoren-06-0612", "Indikator-Details";
								});
  ...
  "subtitle": {
    "text": "Indexwert (Basis 1995 = 100), Basel-Stadt",
    "useHTML": true,
    "align": "left",
    "style": {
      "fontSize": "1em",
  ...
  "series": [
    {
      ...
      "color": "#FF8028",
      "id": "BS0612_1",
      "valueSuffix": "Indexwert (Basis 1995 = 100)",
      "visible": true,
      "_symbolIndex": 0
    },
    {

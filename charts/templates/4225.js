(function(){return {
    ...
    "events": {
      ...
      "load": function () {
								...
								.add().on('click',function(){
									 window.top.location.href = "http://www.umweltberichtbeiderbasel.bs.ch/indikatoren-06-0606", "Indikator-Details";
								});
  ...
  "title": {
    "text": "Energieimportabhängigkeit",
    "useHTML": true,
    "align": "left",
    "style": {
      "fontSize": "1.1666em",

	...
	return {
		...
		colorAxis: {
			...
			dataClasses: [{
				...
				to: 9.99,
				color: '#D3E2E4',
				name: "<span style='color: rgba(0,0,0,0)'>000,0</span> < 10,0"
			}, {
				from: 10,
				to: 11.9,
				color: '#A8C3CA',
				name: "<span style='color: rgba(0,0,0,0)'>0</span>10,0 − 11,9"
			}, {
				from: 12,
				to: 14.9,
				color: '#689199',
				name: "<span style='color: rgba(0,0,0,0)'>0</span>12,0 − 14,9"
			}, {
				from: 15.0,
				to: 17.99,
				color: '#246370',
				name: "<span style='color: rgba(0,0,0,0)'>0</span>15,0 − 17,9"
			}, {
				from: 18,
				color: '#083038',
				name: "<span style='color: rgba(0,0,0,0)'>000,0</span> ≥ 18,0"
			}],
		},
		"data": {
			"seriesMapping": [
		...
		chart: {
			events: {
				load: function (e) {
					...
					fn.addLegendTitle(chart, choroplethSeries.name.replace("lte ", "lte<br/>"), legendPosition.blockChoropleth.title.x, legendPosition.blockChoropleth.title.y[1]);

		...
		chart: {
			events: {
	            load: function (e) {
					...
					fn.addLegendLabelbold(chart, 'Anzahl Wohnungen', 265, 220, 'pieLegendStayeOnZoom');
					fn.addLegendTitle(chart, 'Wohnungen pro Hektare', 265, 300);

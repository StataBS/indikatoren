		...
		"legend": {
         ...
         colorAxis: {
            dataClassColor: 'category',
                ...
                to: 109999,
                color: '#D3E2E4',
                name:  "<span style='color: rgba(0,0,0,0)'>000 0000 </span> <<span style='color: rgba(0,0,0,0)'>0</span>110 000"
            }, {
                from: 110000,
                to: 199999,
                color: '#A8C3CA',
                name: "<span style='color: rgba(0,0,0,0)'>0</span>110 000 −<span style='color: rgba(0,0,0,0)'>0</span>199 999"
            }, {
                from: 200000,
                to: 499999,
                 color: '#689199',
                 name: "<span style='color: rgba(0,0,0,0)'>0</span>200 000 −<span style='color: rgba(0,0,0,0)'>0</span>499 999"
            },{
                from: 500000, 
                to: 659999,
                 color: '#246370',
                 name: "<span style='color: rgba(0,0,0,0)'>0</span>500 000 −<span style='color: rgba(0,0,0,0)'>0</span>649 999"
            },{
                from: 650000,
                color: '#083038',
                name:  "<span style='color: rgba(0,0,0,0)'>000 0000 </span> ≥<span style='color: rgba(0,0,0,0)'>0</span>650 000"
            }], 
        },
        "data": {
		    "seriesMapping": [
